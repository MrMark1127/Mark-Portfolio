...
function Projects() {
    return (
        <Layout content={
            ...
            <h1 className="mt-12 md:mt-8 2xl:mt-24 3xl:mt-32 text-4xl 3xl:text-6xl font-semibold z-40">PROJECTS</h1>
            <h3 className="italic sm:px-4 z-30">This is a work in progress as I finalzie projects I had begun working on but haven't hosted yet.</h3>
                <div className="container flex flex-1 mx-auto -mt-24 2xl:-mt-36 3xl:-mt-48 -mb-8 items-center justify-center overflow-y-scroll scrollbar">
                    <div className="container m-16 h-3/4 grid sm:grid-cols-1 sm:grid-cols-2 grid-flow-row rounded-sm lg:mt-16 m-4"> {/*ADD WHEN MORE THEN 2 PROJECTS LISTED. md:grid-cols-3 */}
                        <ProjectContainer 
