...
function ProjectContainer(props) {
    ...
    return (
            ...
            <a className="h-3/4 pb-2" href={props.anchorLink} target="_blank" rel="noreferrer">
                    <img className={["mt-3 3xl:mt-10 px-1 h-full rounded-sm", props.classProps].join(" ")} src={props.imgSrc} alt="" /></a>
